...
To search the Margie's Travel index, you will use a web application that includes a form in which users can submit search expressions. 
Select your preferred language below, and then follow the steps below to query the Margie's Travel search solution.
